<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="数学" min-width="110px">
        <template slot-scope="scope">
          <span>{{ scope.row.mathScore }}</span>
        </template>
      </el-table-column>
      <el-table-column label="英语" min-width="60px">
        <template slot-scope="scope">
          <span>{{ scope.row.englishScore }}</span>
        </template>
      </el-table-column>
      <el-table-column label="专业课" min-width="50px">
        <template slot-scope="scope">
          <span>{{ scope.row.majorScore }}</span>
        </template>
      </el-table-column>
      <el-table-column label="总分" min-width="80px">
        <template slot-scope="scope">
